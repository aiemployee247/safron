// "Continue with Google" button + divider, shared by sign-in and sign-up.
// A plain anchor: the OAuth flow is a full-page redirect through
// /api/auth/google, so no client-side handler is needed.
